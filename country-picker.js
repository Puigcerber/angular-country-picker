 ...
 * @desc Generate a list of countries as options of  select element.
 * @author Pablo Villoslada Puigcerber <pablo85@gmail.com>
 *
 * @param {string} [pvpCountryPicker=alpha2]  value to which ngModel is bound being  options 'alpha2', 'alpha3',
...
angular.module('angular-country-picker',[])
  .value('pvpCountries',[
    ...
    {"name":"Congo (Democratic Republic)","alpha2":"CD","alpha3":"COD","numeric":"180"},
    ...
    {"name":"French Sourn Territories ","alpha2":"TF","alpha3":"ATF","numeric":"260"},
    ...
    {"name":"Holy See (Vatican)","alpha2":"VA","alpha3":"VAT","numeric":"336"},
    ...
    {"name":"Macedonia ( former Yugoslav Republic of)","alpha2":"MK","alpha3":"MKD","numeric":"807"},
    ...
    {"name":"Nerlands ","alpha2":"NL","alpha3":"NLD","numeric":"528"},
    ...
    {"name":"Norrn Mariana Islands ","alpha2":"MP","alpha3":"MNP","numeric":"580"},
    ...
    {"name":"Saint Vincent and  Grenadines","alpha2":"VC","alpha3":"VCT","numeric":"670"},
    ...
    {"name":"South Georgia and  South Sandwich Islands","alpha2":"GS","alpha3":"SGS","numeric":"239"},
  ...
  .directive('pvpCountryPicker', function($compile, pvpCountries) {
    return {
      ...
      link: function(scope, iElement, iAttrs) {
        ...
        if(! iAttrs.pvpDefaultCountry) {
            iAttrs.pvpDefaultCountry = null;
        }
        var options = '<option ng-repeat="country in countries" ng-selected="{{country.'+iAttrs.pvpCountryPicker+' == \''+iAttrs.pvpDefaultCountry+'\'}}" value="{{country.' + iAttrs.pvpCountryPicker + '}}">{{country.name}}</option>';
